...
class ReciboController extends Controller
{
    ...
    public function pdf(Request $request)
    {
        ...
        /*generamos el query que forma el recibo de pago*/
            ...
            $querypdf = "SELECT sno_hconcepto.codconc, sno_hconcepto.titcon as nomcon, sno_hsalida.valsal ,
                        ...
                        WHERE sno_hsalida.codemp='0001' AND sno_hsalida.codnom  = '$codnom' AND sno_hsalida.anocur='$date' AND sno_hsalida.codperi='$codperi' AND sno_hsalida.codper='$codper' AND sno_hsalida.valsal<>0 
            ...
            /*return view('pruebapdf')with('infopdf', $infopdf);*/
