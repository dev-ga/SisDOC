                ...
                <div class="form-group "> 
                    ...
                    <select name="tiposol" id="tiposol" class="form-control estilosinputregistro mb-2 bordes">
                        <option value="">-- Opciones de Solicitud --</option>
                                ...
                                <option value="Constancia de Trabajo Global">Constancia de Trabajo Global - Contiene Sueldo Mensual + CestaTikect</option>
                                <option value="Constancia de Trabajo Detalla">Constancia de Trabajo Detallada - Contiene Detalle de Asignaciones mensuales del trabajador</option>
